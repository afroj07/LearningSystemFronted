  ...
  return (
    <HomeLayout>
        ...
        noValidate
            ...
            className='flex flex-col items-center justify-center gap-2 rounded-md p-5  text-white shadow-[0_0_10px_black] w-[22rem]'>
            ...
            <div className='flex flex-col w-full  gap-1'>
              ...
              <textarea className='bg-transparent border resize-none h-40 px-2 py-1 rounded-sm'
                  id="message"
                  name='message'
