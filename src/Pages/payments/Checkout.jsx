...
return (
 <HomeLayout>
     ...
     >
      <div className='w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] text-lg rounded-lg relative'>
        <h1 className='bg-yellow-500 absolute top-0 w-full text-center py-4 text-2xl font-bold rounded-tr-lg rounded-tl-lg '>
          Subscription Bundle
        </h1>
